---
기술지원명: Guide to auto layout
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Guide to auto layout
출처링크: https://help.figma.com/hc/en-us/articles/360040451373-Guide-to-auto-layout
게시일: (승인 대기)
검토일: (승인 대기)
---
...
| **Resizing property** | **Can be applied to…** | **Behavior** |
| --- | --- | --- |
