---
기술지원명: Import a CMS collection from a CSV
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Import a CMS collection from a CSV
출처링크: https://help.figma.com/hc/en-us/articles/35691883305879-Import-a-CMS-collection-from-a-CSV
게시일: (승인 대기)
검토일: (승인 대기)
---
