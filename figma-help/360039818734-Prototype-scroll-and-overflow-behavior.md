---
기술지원명: Prototype scroll and overflow behavior
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Prototype scroll and overflow behavior
출처링크: https://help.figma.com/hc/en-us/articles/360039818734-Prototype-scroll-and-overflow-behavior
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Tip: We use the terms **parent**, **child**, **sibling**, and **top-level frame** to describe relationships between objects in Figma. Learn more about [layer hierarchy in Figma →](https://help.figma.com/hc/en-us/articles/360039959014-Parent-child-and-sibling-relationships)
...
Learn more about [how to preserve or reset scroll position in prototypes →](https://help.figma.com/hc/en-us/articles/360051747774-Preserve-scroll-position-in-prototypes)
