---
기술지원명: Hide styles, components, and variables when publishing
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Hide styles, components, and variables when publishing
출처링크: https://help.figma.com/hc/en-us/articles/360039238193-Hide-styles-components-and-variables-when-publishing
게시일: (승인 대기)
검토일: (승인 대기)
---
