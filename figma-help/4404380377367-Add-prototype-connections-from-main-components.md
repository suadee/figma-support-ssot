---
기술지원명: Add prototype connections from main components
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Add prototype connections from main components
출처링크: https://help.figma.com/hc/en-us/articles/4404380377367-Add-prototype-connections-from-main-components
게시일: (승인 대기)
검토일: (승인 대기)
---
