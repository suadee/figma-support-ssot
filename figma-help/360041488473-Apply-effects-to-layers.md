---
기술지원명: Apply effects to layers
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Apply effects to layers
출처링크: https://help.figma.com/hc/en-us/articles/360041488473-Apply-effects-to-layers
게시일: (승인 대기)
검토일: (승인 대기)
---
...
![Demo showing how to add a noise effect.gif](https://help.figma.com/hc/article_attachments/40102284475415)
...
4. Open the **Effect settings** menu to configure the effect:
   ...
   - **Noise size**: Adjust the scale of the noise pixels on the X and Y axis
...
![Demo showing how to add a texture effect.gif](https://help.figma.com/hc/article_attachments/40102330473495)
...
4. Open the **Effect settings** menu to configure the effect:
   - **Size:** Set the scale of the textured effect on the X and Y axis
   ...
   - **Clip to shape:** Enable this option to limit the texture effect to within the layer’s boundary. While the texture itself will be confined to the shape, drop shadows will still interact with the clipped texture, creating a textured shadow effect.  
     ![Demo showing how a drop shadow and texture effect interact.gif](https://help.figma.com/hc/article_attachments/40102284477975)
...
The way Figma renders a selection’s effects depends on the types of effects
applied, their order in the
Effects
section of the right sidebar, and whether the selection is a layer or
a group. Masks are considered groups in this context. The differences
in group and layer shadows are most obvious on layers that overlap. When
the shapes don’t overlap, they will appear the same.
