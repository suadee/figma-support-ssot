---
기술지원명: Use variables in prototypes
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Use variables in prototypes
출처링크: https://help.figma.com/hc/en-us/articles/14506587589399-Use-variables-in-prototypes
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Looking for more examples of how you can use variables in prototypes? Check out some more [advanced prototyping examples](https://help.figma.com/hc/en-us/articles/17146044893591-Advanced-prototyping-examples).
...
[Learn more about applying variables to component and variant properties](https://help.figma.com/hc/en-us/articles/15343107263511-Apply-variables-to-designs).

Try it out: Example 1

1. Create an [interactive component set](https://help.figma.com/hc/en-us/articles/360061175334-Create-interactive-components-with-variants).
