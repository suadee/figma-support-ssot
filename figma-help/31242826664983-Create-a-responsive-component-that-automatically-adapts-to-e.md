---
기술지원명: Create a responsive component that automatically adapts to each breakpoint
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Create a responsive component that automatically adapts to each breakpoint
출처링크: https://help.figma.com/hc/en-us/articles/31242826664983-Create-a-responsive-component-that-automatically-adapts-to-each-breakpoint
게시일: (승인 대기)
검토일: (승인 대기)
---
