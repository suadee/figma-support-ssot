---
기술지원명: Frames in Figma Design
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Frames in Figma Design
출처링크: https://help.figma.com/hc/en-us/articles/360041539473-Frames-in-Figma-Design
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Frames that sit directly on the canvas are called **top-level frames**. Frames that contain other layers are called **parent** objects. Any layers or nested frames inside a parent frame are called **child** objects. Learn more about [the parent, child, and sibling relationship](https://help.figma.com/hc/en-us/articles/360039959014-Parent-child-and-sibling-relationships).
