---
기술지원명: Select layers in a slide deck
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Select layers in a slide deck
출처링크: https://help.figma.com/hc/en-us/articles/27330413404567-Select-layers-in-a-slide-deck
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Slides with complex designs may have layers nested within groups or frames. We refer to nested layers as **children**, and the frames or groups that they nest within as **parents**. Learn more about [parent, child, and sibling relationships](https://help.figma.com/hc/en-us/articles/360039959014-Parent-child-and-sibling-relationships).
...
If you have access to [design mode](https://help.figma.com/hc/en-us/articles/25423848723863-Use-design-mode-in-Figma-Slides), you can view and select layers from the Layers section in the left sidebar. Every layer on a slide has a corresponding layer in the Layers section.
...
- [Smart animate](https://help.figma.com/hc/en-us/articles/24244588378007-Use-slide-transitions#h_01J0VFSNHXH3TKDHTCF18NR8A4): Create advanced transitions between slides
