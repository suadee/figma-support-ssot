---
기술지원명: Add interactions to an element
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Add interactions to an element
출처링크: https://help.figma.com/hc/en-us/articles/31242843431575-Add-interactions-to-an-element
게시일: (승인 대기)
검토일: (승인 대기)
---
