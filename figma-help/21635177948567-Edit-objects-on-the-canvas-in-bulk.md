---
기술지원명: Edit objects on the canvas in bulk
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Edit objects on the canvas in bulk
출처링크: https://help.figma.com/hc/en-us/articles/21635177948567-Edit-objects-on-the-canvas-in-bulk
게시일: (승인 대기)
검토일: (승인 대기)
---
...
You can select multiple layers across frames, groups, or sections either via the canvas or the Layers panel. You can also bulk select matching objects. Learn how to [select multiple layers and matching objects →](https://help.figma.com/hc/en-us/articles/360040449873-Select-layers-and-objects)
