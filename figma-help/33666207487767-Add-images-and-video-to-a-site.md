---
기술지원명: Add images and video to a site
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Add images and video to a site
출처링크: https://help.figma.com/hc/en-us/articles/33666207487767-Add-images-and-video-to-a-site
게시일: (승인 대기)
검토일: (승인 대기)
---
...
**Note**: Figma Sites supports uploads up to 300MB per video file, and up to 1GB of video per site for paid plans. For larger files, we recommend using platforms like YouTube or Vimeo. These services are optimized to balance video quality and internet speed during playback.
