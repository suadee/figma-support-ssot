---
기술지원명: Add a cookie consent banner to your site
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Add a cookie consent banner to your site
출처링크: https://help.figma.com/hc/en-us/articles/34883553489687-Add-a-cookie-consent-banner-to-your-site
게시일: (승인 대기)
검토일: (승인 대기)
---
...
- **Analytics:** Helps you understand how people use your site—e.g., page views, traffic sources, and basic events—so you can improve performance and content.
...
It depends on the features used by your site. For example, if your site uses embeds, those won't load without enabling cookies.
