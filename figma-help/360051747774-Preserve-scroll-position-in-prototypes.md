---
기술지원명: Preserve scroll position in prototypes
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Preserve scroll position in prototypes
출처링크: https://help.figma.com/hc/en-us/articles/360051747774-Preserve-scroll-position-in-prototypes
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Learn more about [prototype state management →](https://help.figma.com/hc/en-us/articles/14397859494295-State-management-for-prototypes)
...
- Objects have the same [set of parents](https://help.figma.com/hc/en-us/articles/360039959014-Parent-child-and-sibling-relationships) across top-level frames
...
Learn more about [renaming layers →](https://help.figma.com/hc/en-us/articles/360039958934-Rename-Layers#3)
