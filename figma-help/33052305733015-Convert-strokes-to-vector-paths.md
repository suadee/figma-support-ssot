---
기술지원명: Convert strokes to vector paths
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Convert strokes to vector paths
출처링크: https://help.figma.com/hc/en-us/articles/33052305733015-Convert-strokes-to-vector-paths
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Once a stroke is converted, you can use [vector edit mode](https://help.figma.com/hc/en-us/articles/360039957634-Edit-vector-layers) to edit the vector path.
