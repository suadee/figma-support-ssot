---
기술지원명: Update fills using the color picker
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Update fills using the color picker
출처링크: https://help.figma.com/hc/en-us/articles/360041003774-Update-fills-using-the-color-picker
게시일: (승인 대기)
검토일: (승인 대기)
---
...
The color picker allows you to configure an object's [layer or stroke fill](https://help.figma.com/hc/en-us/articles/360041003694-Guide-to-fills). Use the color picker to apply solid fills, gradients, patterns, images, and videos. You can also control the hue, saturation, or opacity of a fill, as well as apply blend modes.
...
If the layers in your selection have different fills, you can open the color picker by clicking on one of the fill swatches in the **Selection colors** section of the right sidebar. Learn more about [selection colors](https://help.figma.com/hc/en-us/articles/360042553434-View-and-adjust-colors-in-a-mixed-selection).
...
1. Choose a custom color, or browse color styles and variables from your libraries. Learn more about [applying colors from libraries](https://help.figma.com/hc/en-us/articles/360040316193-Apply-styles-to-layers-and-objects#01H8Q2P6WPNJS32VXCV4C6A0K0).
2. Click the  plus to add a new color [style](https://help.figma.com/hc/en-us/articles/360038746534-Create-color-text-effect-and-layout-guide-styles) or [variable](https://help.figma.com/hc/en-us/articles/14506821864087-Overview-of-variables-collections-and-modes).
...
7. Use the  [eyedropper tool](https://help.figma.com/hc/en-us/articles/27643269375767-Sample-colors-with-the-eyedropper-tool) to select a color from another layer on the canvas.
