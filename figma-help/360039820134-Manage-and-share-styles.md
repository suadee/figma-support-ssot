---
기술지원명: Manage and share styles
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Manage and share styles
출처링크: https://help.figma.com/hc/en-us/articles/360039820134-Manage-and-share-styles
게시일: (승인 대기)
검토일: (승인 대기)
---
...
3. Use the keyboard shortcut to cut the styles:
   - Mac: `⌘ Command` `X`
   - Windows: `Control` `X`
