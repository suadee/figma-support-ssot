---
기술지원명: Variables in Dev Mode
카테고리: 개발
작성자: Figma
승인자: (승인 대기)
출처: Variables in Dev Mode
출처링크: https://help.figma.com/hc/en-us/articles/27882809912471-Variables-in-Dev-Mode
게시일: (승인 대기)
검토일: (승인 대기)
---
...
The **Variables** modal is a read-only version of the [**Variables** modal provided in Figma Design](https://help.figma.com/hc/en-us/articles/15145852043927-Create-and-manage-variables-and-collections#01H8044A3JKE9Q769Z1926VE4A). For example, in the previous image, the **Collection 1** variable collection is displayed in the modal.
...
When you have no layers selected in Dev Mode, you can open a read-only version of the [**Variables** modal provided in Figma Design](https://help.figma.com/hc/en-us/articles/15145852043927-Create-and-manage-variables-and-collections#01H8044A3JKE9Q769Z1926VE4A). To open the modal, in the **Variables** section of the inspect panel, click **Open variables table**. The read-only **Variables** modal appears.
