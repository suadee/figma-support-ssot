...
승인자: (승인 대기)
출처: Shape tools
출처링크: https://help.figma.com/hc/en-us/articles/360040450133-Shape-tools
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Note: For designs that require unique or complex shapes, you can build your own vector networks using the  **Pen** tool. [Learn more →](https://help.figma.com/hc/en-us/articles/360040450213-Vector-networks)
...
**Tip:** Use the [arc tool](https://help.figma.com/hc/en-us/articles/360040450173-Arc-tool-create-arcs-semi-circles-and-rings) to create other shapes, like semi-circles, pie charts, rings, donuts and semi-circular rings.
