---
기술지원명: Copy and paste objects
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Copy and paste objects
출처링크: https://help.figma.com/hc/en-us/articles/4409078832791-Copy-and-paste-objects
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Figma doesn’t have a specific layer type for images or videos. Instead, they are treated as fills. This allows you to add images and video to any layer type, including shapes, frames, text layers, and vector networks. Learn more about [using fills](https://help.figma.com/hc/en-us/articles/360041003694-Guide-to-fills).
...
We recommend downloading a copy of the GIF to your computer, then importing it to Figma using another method. Learn more about [adding GIFs to your designs](https://help.figma.com/hc/en-us/articles/360041486873-Use-animated-GIFs-in-prototypes#add).
