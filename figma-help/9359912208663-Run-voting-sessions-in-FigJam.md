---
기술지원명: Run voting sessions in FigJam
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Run voting sessions in FigJam
출처링크: https://help.figma.com/hc/en-us/articles/9359912208663-Run-voting-sessions-in-FigJam
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Voting sessions can be ended at any time. Anyone in the file can end the session. You can [set a timer to keep the meeting on track](https://help.figma.com/hc/en-us/articles/4402269549591-Stay-on-track-with-the-timer-in-FigJam), but still have to manually end the session.
