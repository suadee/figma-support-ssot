---
기술지원명: Apply blend modes to layers, fills, and effects
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Apply blend modes to layers, fills, and effects
출처링크: https://help.figma.com/hc/en-us/articles/360040667874-Apply-blend-modes-to-layers-fills-and-effects
게시일: (승인 대기)
검토일: (승인 대기)
---
