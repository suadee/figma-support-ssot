---
기술지원명: Connect your prototype
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Connect your prototype
출처링크: https://help.figma.com/hc/en-us/articles/360040315773-Connect-your-prototype
게시일: (승인 대기)
검토일: (승인 대기)
---
...
1. [**Trigger**](https://help.figma.com/hc/en-us/articles/360040035834-Prototype-triggers): Defines what type of interaction will cause the prototype to advance forward, such as a mouse click or touch gesture.
2. **[Action](https://help.figma.com/hc/en-us/articles/360040035874-Prototype-actions)**: Defines what type of event happens when a user interacts with the hotspot, such as moving to another frame, or engaging an overlay.
...
5. **[State management](https://help.figma.com/hc/en-us/articles/14397859494295-State-management-for-prototypes):** Click to reset object properties and states when navigating in and across frames.
6. **[Add action](https://help.figma.com/hc/en-us/articles/15253220891799-Multiple-actions-and-conditionals#Multiple_actions)****:** Add another action to the same trigger.
