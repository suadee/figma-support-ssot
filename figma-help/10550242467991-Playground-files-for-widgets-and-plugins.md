---
기술지원명: Playground files for widgets and plugins
카테고리: 개발
작성자: Figma
승인자: (승인 대기)
출처: Playground files for widgets and plugins
출처링크: https://help.figma.com/hc/en-us/articles/10550242467991-Playground-files-for-widgets-and-plugins
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Publishers can upload any Figma Design, FigJam, Figma Slides, or Figma Buzz files they have can edit access to.

Playground files are Figma Design, FigJam, Figma Slides, or Figma Buzz files that supplement plugins and widgets to show when and how to use the plugin or widget. They are especially helpful for showing how plugins or widgets are used on specific layers.
...
- [**Learn how to publish a plugin →**](https://help.figma.com/hc/en-us/articles/360042293394)
- [**Learn how to publish a widget →**](https://help.figma.com/hc/en-us/articles/4410337103639)

Any Figma Design, FigJam, Figma Slides, or Figma Buzz files you have can edit access to can be used as a playground file, and **do not** need to be published to the Figma Community.
