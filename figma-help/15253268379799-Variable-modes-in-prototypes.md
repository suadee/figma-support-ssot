---
기술지원명: Variable modes in prototypes
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Variable modes in prototypes
출처링크: https://help.figma.com/hc/en-us/articles/15253268379799-Variable-modes-in-prototypes
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Tip: Use [components](https://help.figma.com/hc/en-us/articles/360038662654-Guide-to-components-in-Figma) to save even more time while prototyping with modes. With components, you’ll only need to create the interaction once. Then, place multiple instances on the frame, and change the applied mode for each instance.
...
[Learn more about setting variable modes on objects →](https://help.figma.com/hc/en-us/articles/15343816063383-Modes-for-variables#h_01H3ADKDF7JBTRV1Z5P1X1DZVE)
