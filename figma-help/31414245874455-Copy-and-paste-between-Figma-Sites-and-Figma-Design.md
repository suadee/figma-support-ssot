---
기술지원명: Copy and paste between Figma Sites and Figma Design
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Copy and paste between Figma Sites and Figma Design
출처링크: https://help.figma.com/hc/en-us/articles/31414245874455-Copy-and-paste-between-Figma-Sites-and-Figma-Design
게시일: (승인 대기)
검토일: (승인 대기)
---
...
**Tip**: There are lots of ways you can[modify how content is pasted into Figma Design](https://help.figma.com/hc/en-us/articles/4409078832791-Copy-and-paste-objects#h_01J92HBF9AD0R0NRKPMHT8NJ06), like paste to replace, paste over selection—and more.
