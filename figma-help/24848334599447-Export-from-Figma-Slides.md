---
기술지원명: Export from Figma Slides
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Export from Figma Slides
출처링크: https://help.figma.com/hc/en-us/articles/24848334599447-Export-from-Figma-Slides
게시일: (승인 대기)
검토일: (승인 대기)
---
...
- **Interactive elements and code blocks:** [Live interactions](https://help.figma.com/hc/en-us/articles/24290046072727-Add-interactive-prototypes-to-slides) and [code blocks](https://help.figma.com/hc/en-us/articles/30406262236311-Add-code-blocks-to-slides) will be exported as static images
- **Gradient fills:** Gradient fills will be changed to solid color fills

## Export assets from design mode

While in design mode, you can access the same [export formats and settings](https://help.figma.com/hc/en-us/articles/13402894554519-Export-formats-and-settings) available in Figma Design. This allows you to export content to PNG, JPG, SVG, and PDF, and gives you more control over the exported file. You can export entire slides or individual assets within slides.
