---
기술지원명: Dev Mode statuses and notifications
카테고리: 개발
작성자: Figma
승인자: (승인 대기)
출처: Dev Mode statuses and notifications
출처링크: https://help.figma.com/hc/en-us/articles/26781702258583-Dev-Mode-statuses-and-notifications
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Statuses, including updating a status that’s changed, can be set while editing designs or in Dev Mode. You can also change and update statuses in Dev Mode [ready for dev view](https://help.figma.com/hc/en-us/articles/23918228264855-Dev-Mode-ready-for-dev-view) and [focus view](https://help.figma.com/hc/en-us/articles/23919923330455-Dev-Mode-focus-view).
...
- The **Inspect in Dev Mode** link goes to the [ready for dev view](https://help.figma.com/hc/en-us/articles/23918228264855-Dev-Mode-ready-for-dev-view) for the corresponding Figma file
- The individual cards for designs open the corresponding design in [focus view](https://help.figma.com/hc/en-us/articles/23919923330455-Dev-Mode-focus-view)
