---
기술지원명: Adjust corner radius and smoothing
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Adjust corner radius and smoothing
출처링크: https://help.figma.com/hc/en-us/articles/360050986854-Adjust-corner-radius-and-smoothing
게시일: (승인 대기)
검토일: (승인 대기)
---
...
3. In the **Corner radius details** panel, you can:
   ...
   - Use the slider to adjust [corner smoothing](https://help.figma.com/hc/en-us/articles/360050986854-Adjust-corner-radius-and-smoothing#Corner_smoothing_for_squircles)
