---
기술지원명: About color models
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: About color models
출처링크: https://help.figma.com/hc/en-us/articles/360043042113-About-color-models
게시일: (승인 대기)
검토일: (승인 대기)
---
...
You can view and update colors across different color models using the [color picker](https://help.figma.com/hc/en-us/articles/360041003774-Update-fills-using-the-color-picker).
