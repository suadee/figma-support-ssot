---
기술지원명: Explore design files
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Explore design files
출처링크: https://help.figma.com/hc/en-us/articles/15297425105303-Explore-design-files
게시일: (승인 대기)
검토일: (승인 대기)
---
...
![explore-design-file-annotation.png](https://help.figma.com/hc/article_attachments/41460320730519)

Design files have five distinct regions:

(A) [Navigation bar](#left-sidebar): Contains entry points to various canvas workflows, tools, views, and file notifications.

(B) [Left sidebar](#h_01KVTZ44X6QJC2361SQJM34A10): A panel containing canvas actions based on the tab selection in the Navigation bar.

(C) [Canvas](#canvas): The file’s main workspace where you can create and manipulate designs

(D) [Right sidebar](#right-sidebar): Contains the design properties and prototype properties panels. Also contains actions like sharing and exporting.

(E) [Toolbar](#toolbar): Contains various creation tools, the quick actions menu, and switcher to switch between file modes
...
![left-navbar.png](https://help.figma.com/hc/article_attachments/41460257621527)

The **navigation bar** is the left-most vertical bar in a design file and contains tabs for essential workflows for your canvas—like navigating layers and pages, inserting components, using plugins and shaders, managing variables, and reviewing file notifications.

[Learn more about the navigation bar.](https://help.figma.com/hc/en-us/articles/360039831974)

## Left sidebar

![left-sidebar.png](https://help.figma.com/hc/article_attachments/41460257622295)

The left sidebar is an extension of the navigation bar as it will change depending on the tab you have selected in the navigation bar. For example, when you have the **File** tab selected, you’ll get access to layers and pages, and is where you can take action on your files. The **Assets** tab, is used to view local components or find components from [kits](https://help.figma.com/hc/en-us/articles/24037724065943-Start-designing-with-UI-kits) or [libraries](https://help.figma.com/hc/en-us/articles/360041051154) (requires edit access).
...
When you're ready to dive deeper, you can [explore the right sidebar](https://help.figma.com/hc/en-us/articles/360039832014).
...
Dev Mode allows you to identify designs that are ready for development and access the information needed to transform designs into code. Learn more in our [guide to Dev Mode](https://help.figma.com/hc/en-us/articles/15023124644247).
...
LayoutAppearanceAuto layoutConstraintsFillsStrokeSelection colorsEffectsExport
...
If you're viewing the file as part of the handoff process, then Dev Mode is for you. Dev Mode is a developer-focused interface for inspecting and navigating design files. Learn more in our [guide to Dev Mode](https://help.figma.com/hc/en-us/articles/15023124644247).
