---
기술지원명: Convert text to vector paths
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Convert text to vector paths
출처링크: https://help.figma.com/hc/en-us/articles/360047239073-Convert-text-to-vector-paths
게시일: (승인 대기)
검토일: (승인 대기)
---
...
You can convert any text layer into a vector path. Once converted, you can use [vector edit mode](https://help.figma.com/hc/en-us/articles/360039957634-Edit-vector-layers) to modify the layer's path. This is useful for:
...
**Note:** Looking for information about typing text on a vector path instead? Check out our [Guide to text](https://help.figma.com/hc/en-us/articles/360039956434-Guide-to-text-in-Figma-Design#h_01JTH0B6GEA7AVVXVS72X7ANHK).
...
1. 1. Select the text layer you want to flatten.
   2. Right-click on the selection and select **Flatten**or use the keyboard shortcut:
      ...
      Once flattened, the layers will be combined into a single vector layer. Select the layer and press `Enter` to open [vector edit mode](https://help.figma.com/hc/en-us/articles/360039957634-Edit-vector-layers).
...
When **Outline stroke** is applied, each glyph is converted to its own vector layer, so you can edit each layer individually in [vector edit mode](https://help.figma.com/hc/en-us/articles/360039957634-Edit-vector-layers).
