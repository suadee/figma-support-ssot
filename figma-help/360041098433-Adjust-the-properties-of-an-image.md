---
기술지원명: Adjust the properties of an image
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Adjust the properties of an image
출처링크: https://help.figma.com/hc/en-us/articles/360041098433-Adjust-the-properties-of-an-image
게시일: (승인 대기)
검토일: (승인 대기)
---
...
- **Crop:** Allows you to adjust the boundary lines of your image. This lets you control which part of the image you can see. Cropping is a non-destructive action that works similarly to [using a mask](https://help.figma.com/hc/en-us/articles/360040450253-Masks). Learn more about [cropping images](https://help.figma.com/hc/en-us/articles/360040675194-Crop-an-image).
...
**Note:** You can use the Crop settings to freely rotate an image fill instead. Learn more about [cropping images](https://help.figma.com/hc/en-us/articles/360040675194-Crop-an-image).
