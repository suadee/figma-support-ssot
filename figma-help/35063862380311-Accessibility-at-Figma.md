---
기술지원명: Accessibility at Figma
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Accessibility at Figma
출처링크: https://help.figma.com/hc/en-us/articles/35063862380311-Accessibility-at-Figma
게시일: (승인 대기)
검토일: (승인 대기)
---
...
- Simplify focus navigation in the [**Actions** menu](https://help.figma.com/hc/en-us/articles/23570416033943-Use-the-actions-menu-in-Figma-Design)
...
- Toggle automatically following a collaborator when they turn on [spotlight](https://help.figma.com/hc/en-us/articles/360040322673-Present-to-collaborators-using-spotlight#file) in a file
...
[Learn more about the Actions menu.](https://help.figma.com/hc/en-us/articles/23570416033943-Use-the-actions-menu-in-Figma-Design#h_01J0XWBCYBAPNE2615C6JGM75Q)
...
#### Place a comment on the canvas with the Comment Cursor

1. Press `C` to enter comment mode.
2. Press `F6`, or use `Tab` or `Shift` `Tab`, until focus reaches the **Comment Cursor**.
3. Use the arrow keys to pan the canvas, then press `Enter` to place a comment.

With the Comment Cursor focused, use `Tab` or `Shift` `Tab` to move through comment clusters or pins. When you reach the end of the navigation order, focus cycles back to the Comment Cursor.
...
[Learn more about annotating designs.](https://help.figma.com/hc/en-us/articles/20774752502935-Add-measurements-and-annotate-designs)
...
[Learn more about changing the background color of the canvas.](https://help.figma.com/hc/en-us/articles/360041064814-Change-the-background-color-of-the-canvas)
...
[Learn more about using presenter notes in Figma Slides.](https://help.figma.com/hc/en-us/articles/24245848829847-Add-and-view-presenter-notes)
