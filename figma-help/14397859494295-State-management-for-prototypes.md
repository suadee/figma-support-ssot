---
기술지원명: State management for prototypes
카테고리: 디자인
작성자: Figma
승인자: suadee
출처: State management for prototypes
출처링크: https://help.figma.com/hc/en-us/articles/14397859494295-State-management-for-prototypes
게시일: 2026-07-22
검토일: 2026-07-22
---
...
State management can be used with [interactive components](https://help.figma.com/hc/en-us/articles/360061175334-Create-interactive-components-with-variants), [scroll position](https://help.figma.com/hc/en-us/articles/360039818734-Prototype-scroll-and-overflow-behavior), and [videos in prototypes](https://help.figma.com/hc/en-us/articles/8878274530455-Add-video-to-prototypes) in three ways:
...
Objects are considered matching if they have the same layer name and the same [set of parents](https://help.figma.com/hc/en-us/articles/360039959014-Parent-child-and-sibling-relationships) across top-level frames.
...
Tip: Need to rename layers? Learn how to [rename layers in bulk →](https://help.figma.com/hc/en-us/articles/360039958934-Rename-Layers)
...
Note: In new interactions, scroll position is shared automatically, as long as [object names match across frames](https://help.figma.com/hc/en-us/articles/14397859494295-State-management-for-prototypes#Top-level_frames).   
