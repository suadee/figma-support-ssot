---
기술지원명: Accept invitations
카테고리: 관리
작성자: Figma
승인자: (승인 대기)
출처: Accept invitations
출처링크: https://help.figma.com/hc/en-us/articles/1500008023902-Accept-invitations
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Available on [any team or plan](https://help.figma.com/hc/en-us/articles/360040328273-Choose-a-Figma-Plan)

Anyone with a Figma account can accept invitations

Accept invitations to join files, projects, teams, or organizations. **[Guide to sharing and permissions →](https://help.figma.com/hc/en-us/articles/1500007609322-Guide-to-sharing-and-permissions)**

You need to have a Figma account to accept a file, team, or organization invitation. **[Create a Figma account →](https://help.figma.com/hc/en-us/articles/360039811114-Create-a-Figma-account)**
...
Your invitation will confirm if you have been invited to **view** or **edit** the file. **[Learn more about permissions in teams →](https://help.figma.com/hc/en-us/articles/360039970673-Roles-and-permissions-in-teams)**
...
![Invitation email with a button labeled "Open in Figma" to view the file.](https://help.figma.com/hc/article_attachments/1500012045421)
...
![Notification panel showing an invitation to join the Design Ops team with options to accept or decline.](https://help.figma.com/hc/article_attachments/15135554456087)

**[Learn more about notifications →](https://help.figma.com/hc/en-us/articles/360039813234)**
...
This allows you to quickly [share links or embed files and prototypes](https://help.figma.com/hc/en-us/articles/360040531773-Share-or-embed-your-files-and-prototypes) in external websites without having to manage access for collaborators individually.
...
You can interact with files based on your permissions. If you were invited with can view access, you can only view the file. If you were invited with can edit access, you can get edit access to the file. **[Permissions in teams →](https://help.figma.com/hc/en-us/articles/360039970673)**
...
1. Click the **Edit file** button in the toolbar. If you hover over this button, Figma will display the link sharing permissions for the file.
2. Figma will allow you to edit that file.

### Can view access

You can tell if you have view access if you see **Ask to edit** on the toolbar.

![Toolbar showing navigation tools and 'Ask to edit' button for view-only file access in Figma.](https://help.figma.com/hc/article_attachments/31325615213719)
...
- Save a [copy of files to your computer](https://help.figma.com/hc/en-us/articles/8403626871063-Save-a-local-copy-of-a-file) (as .fig or .jam files) or [duplicate the file](https://help.figma.com/hc/en-us/articles/360038511533-Duplicate-files)
...
**Note:** Actions with an asterisk\* are only supported if the **Allow viewers to copy, share, and export from this file** setting is on. **[Restrict who can copy and share files →](https://help.figma.com/hc/en-us/articles/360040045574%20target=)**

### Can edit access

If you were invited to the file with `can edit` access, you may be able to edit the file using the tools available in the toolbar. For example, in Figma Design, you'll see shape, object editing, text tools, and more:

![Figma toolbar showing tools for design editing.](https://help.figma.com/hc/article_attachments/31325589077271)
...
![Figma notification showing an invitation to join the Design Ops team with Accept and Decline options.](https://help.figma.com/hc/article_attachments/15135554456087)
...
1. Click the link to redeem the invitation.
2. If you're logged into more than one account, choose which account to join the team with.
3. Figma will add you to the team.
...
[Guide to files and projects →](https://help.figma.com/hc/en-us/articles/1500005554982)
...
**Note:** You can see what type of team you have under the team name and description. This is useful when determining what features and functions you can access. **[Compare teams and plans →](https://help.figma.com/hc/en-us/articles/360040328273-Compare-teams-and-plans)**

![Figma team page showing projects, member list, and options to invite members.](https://help.figma.com/hc/article_attachments/15646174279447)

[Explore Figma →](https://help.figma.com/hc/en-us/articles/360041543473)
...
- **Accept invitations ↓**
- **[By opening a link to a file →](https://help.figma.com/hc/en-us/articles/360040044834)**
- **[Via domain capture →](https://help.figma.com/hc/en-us/articles/360045953273)**
...
Guests have limited access to the organization and must be invited to specific teams, projects, or files to access them. **[Learn more about members and guests →](https://help.figma.com/hc/en-us/articles/360039960434#Account_types)**
