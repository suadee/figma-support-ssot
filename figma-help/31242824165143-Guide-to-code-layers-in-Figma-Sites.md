---
기술지원명: Guide to code layers in Figma Sites
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Guide to code layers in Figma Sites
출처링크: https://help.figma.com/hc/en-us/articles/31242824165143-Guide-to-code-layers-in-Figma-Sites
게시일: (승인 대기)
검토일: (승인 대기)
---
