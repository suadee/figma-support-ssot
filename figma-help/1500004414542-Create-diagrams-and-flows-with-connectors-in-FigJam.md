---
기술지원명: Create diagrams and flows with connectors in FigJam
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Create diagrams and flows with connectors in FigJam
출처링크: https://help.figma.com/hc/en-us/articles/1500004414542-Create-diagrams-and-flows-with-connectors-in-FigJam
게시일: (승인 대기)
검토일: (승인 대기)
---
...
You can use connectors to build diagrams like flowcharts, system maps, and workflows. You can create diagrams manually using shapes and connectors, or generate them automatically using AI features or supported integrations.
...
In addition to building diagrams manually, you can generate diagrams in FigJam using AI features or supported integrations.

You can:

- [Use FigJam AI to generate diagrams from a text description](https://help.figma.com/hc/en-us/articles/18706554628119-Make-boards-and-diagrams-with-FigJam-AI)
- Paste Mermaid.js syntax onto the board to render diagrams like flowcharts,
  system diagrams, or entity relationship diagrams (ERDs)

For examples of Mermaid syntax you can use, see the
[Mermaid documentation](https://mermaid.js.org/syntax/examples.html).

Generated diagrams are fully editable, so you can move objects, update text, and adjust connections just like manually created diagrams.
