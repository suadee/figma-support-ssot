---
기술지원명: Use Figma products with a keyboard
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Use Figma products with a keyboard
출처링크: https://help.figma.com/hc/en-us/articles/360040328653-Use-Figma-products-with-a-keyboard
게시일: (승인 대기)
검토일: (승인 대기)
---
...
1. Enable the desired tool using its keyboard shortcut, the [actions menu](https://help.figma.com/hc/en-us/articles/23570416033943-Use-the-actions-menu-in-Figma-Design), or press `F6` (Mac) or `Ctrl` `F6` (Windows) until the toolbar is focused, then use the arrow keys to select the tool.
...
- Type `Screen reader` in the [actions menu](https://help.figma.com/hc/en-us/articles/23570416033943-Use-the-actions-menu-in-Figma-Design) and press `Return` / `Enter`
...
- Type `Keyboard shortcuts` in the [actions menu](https://help.figma.com/hc/en-us/articles/23570416033943-Use-the-actions-menu-in-Figma-Design)
