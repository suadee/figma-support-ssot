---
기술지원명: Create bulleted and numbered lists
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Create bulleted and numbered lists
출처링크: https://help.figma.com/hc/en-us/articles/360040449773-Create-bulleted-and-numbered-lists
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Note: Figma will create a new paragraph when you use the `Enter` or `Return` keys. This is something to bear in mind if your [text resizing](https://help.figma.com/hc/en-us/articles/360039956634-Explore-text-properties#basic) is set to **Auto Width**.
