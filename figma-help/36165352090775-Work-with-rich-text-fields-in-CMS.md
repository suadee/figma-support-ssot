---
기술지원명: Work with rich text fields in CMS
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Work with rich text fields in CMS
출처링크: https://help.figma.com/hc/en-us/articles/36165352090775-Work-with-rich-text-fields-in-CMS
게시일: (승인 대기)
검토일: (승인 대기)
---
...
You can also add [alt text](https://help.figma.com/hc/en-us/articles/31242789265431-Improve-the-accessibility-of-your-site#h_01K5C8GB5DGZPBSP2NQFRRANYM) to the image to provide context for users who rely on screen readers. Leave the alt text blank to have screen readers to skip the image.
...
A [text style](https://help.figma.com/hc/en-us/articles/360039957034-Create-and-apply-text-styles) is a reusable set of typographic properties applied to text layers to ensure design consistency. In Figma Sites files, Figma automatically creates a set of **Rich text styles** when you connect a text layer to a rich text field. The rich text styles let you customize each of your headings, as well as the body text.

You can [adjust these styles in the right sidebar](https://help.figma.com/hc/en-us/articles/360039957034-Create-and-apply-text-styles), just like regular text styles.
