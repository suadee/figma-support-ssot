---
기술지원명: Combine vertical, horizontal, and grid auto layout flows
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Combine vertical, horizontal, and grid auto layout flows
출처링크: https://help.figma.com/hc/en-us/articles/31441443713047-Combine-vertical-horizontal-and-grid-auto-layout-flows
게시일: (승인 대기)
검토일: (승인 대기)
---
...
[Learn more about nesting and parent, child, and sibling relationships.](https://help.figma.com/hc/en-us/articles/360039959014-Parent-child-and-sibling-relationships)
...
2. Choose a mobile [frame preset](https://help.figma.com/hc/en-us/articles/360041539473-Frames-in-Figma-Design#h_01JH5Y0VVZJVB5AXYNYAHJRV3R) from the right sidebar.
