---
기술지원명: Add images and videos to slides
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Add images and videos to slides
출처링크: https://help.figma.com/hc/en-us/articles/25427361244183-Add-images-and-videos-to-slides
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Note: When you upload an SVG to Figma Slides, it is no longer treated as an image and cannot be used to fill media placeholders. Instead, SVGs are converted to [editable vector layers](https://help.figma.com/hc/en-us/articles/360040450213-Vector-networks).
...
Once added, you can use the Fill section in the right sidebar to adjust how your visual looks. Learn more about [adjusting image or video properties](https://help.figma.com/hc/en-us/articles/25427967539991-Adjust-image-or-video-properties).

Note: Animated GIFs display as static images when viewing a deck in the Figma Slides editor. To play an animated GIF, open the deck in [presenter view](https://help.figma.com/hc/en-us/articles/24338209202327-Present-a-slide-deck).
