---
기술지원명: Use gradients as a fill or stroke
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Use gradients as a fill or stroke
출처링크: https://help.figma.com/hc/en-us/articles/34208860210199-Use-gradients-as-a-fill-or-stroke
게시일: (승인 대기)
검토일: (승인 대기)
---
...
You can use [variables](https://help.figma.com/hc/en-us/articles/15339657135383-Guide-to-variables-in-Figma) on color stops in a gradient to maintain consistency in your design system.
...
**Note:** You can save gradients, which may contain variable values, as styles to be reused throughout your designs. Learn more about creating [color styles](https://help.figma.com/hc/en-us/articles/360038746534-Create-color-text-effect-and-layout-guide-styles).
