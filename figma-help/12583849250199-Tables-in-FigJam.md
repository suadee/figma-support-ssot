---
기술지원명: Tables in FigJam
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Tables in FigJam
출처링크: https://help.figma.com/hc/en-us/articles/12583849250199-Tables-in-FigJam
게시일: (승인 대기)
검토일: (승인 대기)
---
...
- Adjust font size, color, and typeface
...
[Learn more about editing text properties in FigJam →](https://help.figma.com/hc/en-us/articles/1500004291281-Create-text-and-links-in-FigJam#Text_properties)

### Merge cells

To merge cells in a table:

1. Select the adjacent cells you’d like to merge.
2. From the inline toolbar, select  **Merge cells**.
...
[Learn more about resizing objects in FigJam →](https://help.figma.com/hc/en-us/articles/1500006206242-Resize-rotate-and-flip-objects-in-FigJam)
...
1. Press `⌘ Command``/` or `Control`+`/` to open the [quick actions menu](https://help.figma.com/hc/en-us/articles/360040328653).
...
[Learn more about exporting from FigJam →](https://help.figma.com/hc/en-us/articles/4407699832855-Export-your-FigJam-board)
