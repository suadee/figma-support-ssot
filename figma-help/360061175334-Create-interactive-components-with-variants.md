---
기술지원명: Create interactive components with variants
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Create interactive components with variants
출처링크: https://help.figma.com/hc/en-us/articles/360061175334-Create-interactive-components-with-variants
게시일: (승인 대기)
검토일: (승인 대기)
---
