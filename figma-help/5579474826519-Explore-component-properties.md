---
기술지원명: Explore component properties
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Explore component properties
출처링크: https://help.figma.com/hc/en-us/articles/5579474826519-Explore-component-properties
게시일: (승인 대기)
검토일: (승인 대기)
---
...
**Simplified instances will be deprecated starting on March 23, 2026** to improve consistency for component properties across files. All component instances with simplified instances will instead show all component properties and layers by default.  
  
Here’s what you can expect:

- All component properties will be visible in the **Properties** panel by default in the right panel.
- Layers that were previously hidden by simplified instances will appear in the **Layers** section in the left panel.
...
Anyone with edit access to the Figma Design file can create,
manage, and use component props

This article covers how to create and configure component properties.
Learn how to
[edit instances with component properties](https://help.figma.com/hc/en-us/articles/8883757553943).
...
| [Slot property](#h_01JCH52HY9Y5XDH2G83CGR4BXB) | Create a flexible area in a component where you can add, edit, and rearrange content. |
...
3. From the **Create component property** modal, use the fields and dropdown menus to configure the property.
   ...
   - If desired, set up any [preferred instances](#preferred) so others know which components they should choose from when swapping the instance.
4. Click **Create property.**
...
### Choose preferred instances

Preferred instances allow you to create a curated set of components to choose from when swapping instances (via the instance swap property). They reduce guesswork by communicating which specific components can replace an existing one.
...
>   
> To make it easy find these 8 icons and to know which one can be used, you add them as preferred instances. Now, whenever designers go to swap the icon, they have a curated list of assets they know they can use.

![](https://help.figma.com/hc/article_attachments/24377633468439)

When using a component with a preferred instance, a list of preferred instances appear by default when opening the instance swap property menu.

Note: If you don’t want to use a preferred instance, click the dropdown or use the search bar above the list to find other components from available.

To add preferred instances:

1. Start by editing its existing instance swap property or creating a new one.
2. From the respective modals, click  in the **Preferred instances** section and check the checkboxes next to the instances you want to include as a preferred values.

To remove a preferred instance, click  next to the item in the **Preferred instance** section of the modal.
...
Slots are flexible areas added to components that let you freely add and arrange content directly inside an instance without having to detach it, all while maintaining adherence to your team's design system. Slots are great for components with repeating items—like a task list—or with freeform layouts—like modals and cards.

[Learn more about slots.](https://help.figma.com/hc/articles/38231200344599/)
