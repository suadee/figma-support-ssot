---
기술지원명: Arrange layers with Smart selection
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Arrange layers with Smart selection
출처링크: https://help.figma.com/hc/en-us/articles/360040450233-Arrange-layers-with-Smart-selection
게시일: (승인 대기)
검토일: (승인 대기)
---
...
- A 
  ...
  **Tip:** Hold down `Shift` while scrolling to adjust the increments by the amount specified in your **Big nudge** settings. [Learn more about setting custom nudge values.](https://help.figma.com/hc/en-us/articles/4404575206295-Set-small-and-big-nudge-values)
- B 
