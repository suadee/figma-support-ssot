---
기술지원명: Add, select, and edit objects across multiple breakpoints
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Add, select, and edit objects across multiple breakpoints
출처링크: https://help.figma.com/hc/en-us/articles/31242788601879-Add-select-and-edit-objects-across-multiple-breakpoints
게시일: (승인 대기)
검토일: (승인 대기)
---
