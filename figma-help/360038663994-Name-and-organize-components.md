---
기술지원명: Name and organize components
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Name and organize components
출처링크: https://help.figma.com/hc/en-us/articles/360038663994-Name-and-organize-components
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Note: For this approach, you will need to [publish your library](https://help.figma.com/hc/en-us/articles/360025508373-Publish-a-library) and [add it to the other file](https://help.figma.com/hc/en-us/articles/1500008731201-Add-or-remove-a-library-from-a-design-file). The ability to publish libraries is only available on our [paid plans](https://help.figma.com/hc/en-us/articles/360040328273-Figma-plans-and-features).
