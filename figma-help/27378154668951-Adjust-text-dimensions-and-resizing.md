---
기술지원명: Adjust text dimensions and resizing
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Adjust text dimensions and resizing
출처링크: https://help.figma.com/hc/en-us/articles/27378154668951-Adjust-text-dimensions-and-resizing
게시일: (승인 대기)
검토일: (승인 대기)
---
...
- **Font size:** Adjust the font size of the text contents, not the layer (See: [Explore type properties](https://help.figma.com/hc/en-us/articles/360039956634-Explore-text-properties#basic)).
...
You can also use the [scale tool](https://help.figma.com/hc/en-us/articles/360040451453) to change the size of a text layer. If you take this approach, you'll change the [font size](https://help.figma.com/hc/en-us/articles/360039956634-Explore-text-properties#font-size), as well as the bounds of the text layer.
