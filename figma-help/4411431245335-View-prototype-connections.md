---
기술지원명: View prototype connections
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: View prototype connections
출처링크: https://help.figma.com/hc/en-us/articles/4411431245335-View-prototype-connections
게시일: (승인 대기)
검토일: (승인 대기)
---
...
2. View the connection details in the **Properties >** **Interactions** section of the right sidebar.
   - Type of interaction that [triggers](https://help.figma.com/hc/en-us/articles/360040035834-Prototype-triggers) the flow.
   - [Prototype action](https://help.figma.com/hc/en-us/articles/360040035874-Prototype-actions) and the destination.
   - Type of [prototype animation](https://help.figma.com/hc/en-us/articles/360040522373-Prototype-animations). If this is an animation that supports a direction, you'll see the origin direction next to the animation name. For example, if the next frame comes from the right and moves left, Figma will show this as **Right**.
...
View prototype flows in the [Properties tab of the right sidebar](https://help.figma.com/hc/en-us/articles/360039832014-Design-prototype-and-explore-layer-properties-in-the-right-sidebar#h_01HKASPBBX9V0S5VA9F3XWRM2S).
...
5. Hover over the flow to view the actions you can take:
   ...
   - Select  **Preview** to open the flow in [inline preview](https://help.figma.com/hc/en-us/articles/360040318013-Play-your-prototypes)
