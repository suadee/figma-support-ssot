---
기술지원명: Compare changes in Dev Mode
카테고리: 개발
작성자: Figma
승인자: (승인 대기)
출처: Compare changes in Dev Mode
출처링크: https://help.figma.com/hc/en-us/articles/15023193382935-Compare-changes-in-Dev-Mode
게시일: (승인 대기)
검토일: (승인 대기)
---
...
- E 
  ...
  [Learn more about using code snippets in Dev Mode →](https://help.figma.com/hc/en-us/articles/15023202277399-Use-code-snippets-in-Dev-Mode)
- F 
