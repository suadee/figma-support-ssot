---
기술지원명: Add Figma Design libraries to your slide deck
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Add Figma Design libraries to your slide deck
출처링크: https://help.figma.com/hc/en-us/articles/24292359259543-Add-Figma-Design-libraries-to-your-slide-deck
게시일: (승인 대기)
검토일: (승인 대기)
---
...
You can only apply variables to objects while in design mode. Applying variables in Figma Slides works the same as it does in Figma Design. Learn more about [applying variables to designs](https://help.figma.com/hc/en-us/articles/15343107263511-Apply-variables-to-designs).

### Apply variable modes

You can switch the variable mode on an object or slide so the design displays the variable values you want. Variable modes are available in slides and design mode. Learn more about [variable modes](https://help.figma.com/hc/en-us/articles/15343816063383-Modes-for-variables#h_01H3ADKDF7JBTRV1Z5P1X1DZVE).
...
If you’re using design mode, accessing styles works the same way it does in Figma Design. Learn more about [applying styles to layers and objects](https://help.figma.com/hc/en-us/articles/360040316193-Apply-styles-to-layers-and-objects).
