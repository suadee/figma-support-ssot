---
기술지원명: Insert blocks, embeds, webpages, and design libraries into a site
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Insert blocks, embeds, webpages, and design libraries into a site
출처링크: https://help.figma.com/hc/en-us/articles/31242773374615-Insert-blocks-embeds-webpages-and-design-libraries-into-a-site
게시일: (승인 대기)
검토일: (승인 대기)
---
