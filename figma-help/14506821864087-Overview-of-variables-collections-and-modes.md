---
기술지원명: Overview of variables, collections, and modes
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Overview of variables, collections, and modes
출처링크: https://help.figma.com/hc/en-us/articles/14506821864087-Overview-of-variables-collections-and-modes
게시일: (승인 대기)
검토일: (승인 대기)
---
...
There are six types of variables. Each one can be applied to specific properties and elements.
...
| Easing | Easing curve or spring animation |
...
- [Stroke colors](https://help.figma.com/hc/en-us/articles/360049283914-Apply-and-adjust-stroke-properties#paints)
...
- [Corner radius and individual corner radius](https://help.figma.com/hc/en-us/articles/360050986854-Adjust-corner-radius-and-smoothing)
...
- [Stroke weight](https://help.figma.com/hc/en-us/articles/360049283914-Apply-and-adjust-stroke-properties): all, top, bottom, left, and right
- Text content
- [Text styles](https://help.figma.com/hc/en-us/articles/360039957034)
- [Preset animations](https://help.figma.com/hc/en-us/articles/41307886266135) in Figma Motion:
  - Position distance
  - Scale amount
  - Rotation amount
  - Size amount
...
- [Layer visibility](https://help.figma.com/hc/en-us/articles/360041112614-Toggle-visibility-to-hide-layers), if the string has a value of “true” or “false”
- Text content
- [Text styles](https://help.figma.com/hc/en-us/articles/360039957034)
- [Variant instances in prototyping](https://help.figma.com/hc/en-us/articles/14506587589399-Use-variables-in-prototypes#h_01H91B3F52N6YVB3RG3RG0GSGS)
...
- [Instances with variant property](https://help.figma.com/hc/en-us/articles/14506587589399-Use-variables-in-prototypes#h_01H91B3F52N6YVB3RG3RG0GSGS) with true and false values
- [Layer visibility](https://help.figma.com/hc/en-us/articles/360041112614-Toggle-visibility-to-hide-layers)

### Timing variable

Timing variables use time-based values in milliseconds to define how long an animation takes to complete, such as `500ms`. You can use timing variables to ensure every animation across your product uses a consistent, approved delay or duration. Timing variables can be applied to a preset animation’s delay and duration in [Figma Motion](https://help.figma.com/hc/en-us/articles/41274629073303).

### Easing variable

Easing variables use easing curves or spring animations, either pre-built or custom, to control how an animated property progresses toward its end value over time. They’re what give motion its character, creating effects like acceleration, deceleration, and bounce that reflect your brand’s personality. Easing variables can be applied to animation presets and keyframes in [Figma Motion](https://help.figma.com/hc/en-us/articles/41274629073303). Learn more about [easing](https://help.figma.com/hc/en-us/articles/41414048690839).
