---
기술지원명: Apply changes to instances
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Apply changes to instances
출처링크: https://help.figma.com/hc/en-us/articles/360039150733-Apply-changes-to-instances
게시일: (승인 대기)
검토일: (승인 대기)
---
...
2. Edit or adjust the property you’d like to change. For example, to [change the fill of a layer](https://help.figma.com/hc/en-us/articles/360040623954-Add-fills-to-text-and-shape-layers), edit the **Fill** section of the right sidebar.
...
For changes like reordering layers, you must [detach the instance](https://help.figma.com/hc/en-us/articles/360038665754-Detach-an-instance-from-the-component), or make the changes directly to the main component
...
**Note:** If you are working in a published library file, you need to [publish your changes](https://help.figma.com/hc/en-us/articles/360038665934#Publish_changes_to_the_library) to allow other instances to receive those updates.
