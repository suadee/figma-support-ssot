---
기술지원명: Create color, text, effect, and layout guide styles
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Create color, text, effect, and layout guide styles
출처링크: https://help.figma.com/hc/en-us/articles/360038746534-Create-color-text-effect-and-layout-guide-styles
게시일: (승인 대기)
검토일: (승인 대기)
---
