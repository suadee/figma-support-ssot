---
기술지원명: Apply variables to designs
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Apply variables to designs
출처링크: https://help.figma.com/hc/en-us/articles/15343107263511-Apply-variables-to-designs
게시일: (승인 대기)
검토일: (승인 대기)
---
...
You can also [apply color variables within a mixed selection](https://help.figma.com/hc/en-us/articles/360042553434-View-and-adjust-colors-in-a-mixed-selection).
...
## Apply a timing variable

Timing variables can be added to a preset animation’s delay or duration while in [Figma Motion](https://help.figma.com/hc/en-us/articles/41274629073303).

To apply a timing variable:

1. Select a preset animation on the timeline.
2. Click  **Apply variable** next to the Delay or Duration field.
3. Select a variable from the picker.

![](https://help.figma.com/hc/article_attachments/41460320123927)

## Apply an easing variable

Easing variables can be added to an animation’s easing curve while in [Figma Motion](https://help.figma.com/hc/en-us/articles/41274629073303).

To apply an easing variable:

1. Select an animation on the timeline or click the line between two keyframes.
2. Click  **Apply variable** next to the **Easing** setting.
3. Select a variable from the picker.

![](https://help.figma.com/hc/article_attachments/41460257005463)
