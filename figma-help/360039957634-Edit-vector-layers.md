---
기술지원명: Edit vector layers
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Edit vector layers
출처링크: https://help.figma.com/hc/en-us/articles/360039957634-Edit-vector-layers
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Vector edit mode lets you select, adjust, and change the properties of vector layers, [including basic shapes](https://help.figma.com/hc/en-us/articles/360040450133-Shape-tools) and custom vector networks drawn with the [Pen](https://help.figma.com/hc/en-us/articles/360040450213-Vector-networks), [Brush](https://help.figma.com/hc/en-us/articles/31440438150935), or [Pencil](https://help.figma.com/hc/en-us/articles/31440438150935) tools.
...
- The Variable width tool cannot be used on vector networks with branching paths. You can right-click on the vector and select **Split vector** or type **Split vector** into the [Actions menu](https://help.figma.com/hc/en-us/articles/23570416033943-Use-the-actions-menu-in-Figma-Design#h_01J0XWBCYBAPNE2615C6JGM75Q) to split a branching network into individual paths.
...
**Tip:** If [Snap to pixel grid](https://help.figma.com/hc/en-us/articles/360041065034-Adjust-your-zoom-and-view-options#snap-grid) is enabled, you can hold `Control` while adjusting the handle to temporarily ignore the pixel grid.
...
You can round individual corners of a vector network using the **Corner radius** setting in the right sidebar. If the vector network is an open path, you can use caps to round endpoints. Learn more about [corner radius and smoothing](https://help.figma.com/hc/en-us/articles/360050986854-Adjust-corner-radius-and-smoothing).
