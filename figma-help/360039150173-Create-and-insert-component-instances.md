---
기술지원명: Create and insert component instances
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Create and insert component instances
출처링크: https://help.figma.com/hc/en-us/articles/360039150173-Create-and-insert-component-instances
게시일: (승인 대기)
검토일: (승인 대기)
---
...
- From the [assets tab](#assets-panel) in the navigation bar
- From the [component details modal](#h_01H967BDDFRX012YSNY661ZZBJ), accessible from the assets tab
- Using the asset tab of the [actions menu](#quick-insert)
- By [copying or duplicating](#copy-duplicte) an instance

**Tip:** You can handoff component instances for development without reorganizing your file by [marking instances as ready for dev in Dev Mode](https://help.figma.com/hc/en-us/articles/15023124644247-Guide-to-Dev-Mode#View_which_sections_are_ready_for_development).

## Assets tab

The **Assets** tab in the navigation bar on the left allows you to search for components to add to your file. You can choose which libraries are available in the **Assets** tab.

![left-nav-assets.png](https://help.figma.com/hc/article_attachments/41871219769879)

To open the Assets tab:

1. Select the **Assets** tab in the navigation bar, or use the shortcut:
   - **Mac**: `⌥ Option` `2`
   - **Windows:** `Alt` `2`
...
**Note**: Is the library you need missing from the Assets tab? Click  to browse available libraries in your team or organization and add them to your file.
...
[Learn more about finding main components.](https://help.figma.com/hc/en-us/articles/360038665934-Edit-main-components#find-components)
