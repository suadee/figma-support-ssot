---
기술지원명: Guide to text in Figma Design
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Guide to text in Figma Design
출처링크: https://help.figma.com/hc/en-us/articles/360039956434-Guide-to-text-in-Figma-Design
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Text is a crucial component of interface design. In this article, we’ll cover how to create, edit, and style text in Figma Design. Learn more about using text in [FigJam](https://help.figma.com/hc/en-us/articles/1500004291281-Create-text-and-links-in-FigJam) or [Figma Slides](https://help.figma.com/hc/en-us/sections/24146049244695).
...
![](https://help.figma.com/hc/article_attachments/40102330486423)
...
![](https://help.figma.com/hc/article_attachments/40102284492439)
...
![](https://help.figma.com/hc/article_attachments/40102284492695)
...
1. Select the  **Text on a path** tool from the toolbar.
2. Hover your cursor over the path of a vector object until the  text on a path cursor appears.
3. Click to add a new text layer and start typing.

![Area.gif](https://help.figma.com/hc/article_attachments/40102330488215)
...
[Browse, preview, and select fonts](https://help.figma.com/hc/en-us/articles/360041308034-Browse-and-apply-fonts) in the **Typography** section of the right sidebar. There are three ways to use fonts in Figma Design:
...
- **Stroke**: Add an outline around individual characters in a text layer using [**Stroke**](https://help.figma.com/hc/en-us/articles/360049283914-Apply-and-adjust-stroke-properties).

**Want to adjust the background color of a text layer?** Applying a fill to a text layer will only update the color of the text. To add a fill behind text, you can add the text layer to a [frame](https://help.figma.com/hc/en-us/articles/360041539473-Frames-in-Figma-Design) and update the **Fill** of the frame instead.
