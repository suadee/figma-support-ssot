---
기술지원명: Publish a library
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Publish a library
출처링크: https://help.figma.com/hc/en-us/articles/360025508373-Publish-a-library
게시일: (승인 대기)
검토일: (승인 대기)
---
...
![publish-a-library.png](https://help.figma.com/hc/article_attachments/41460306252695)
...
6. *Organization and Enterprise plans only:* Use the dropdown menu to choose [where to publish the library](#h_01J688PTA7N7AHMGZMA6QA1F1V).
...
If you make changes to a style, component, or variable in a library’s source file, those changes will only appear in the current file until you publish them. Publishing updates to a library follows the same process as [publishing a library for the first time](#h_01J688PTA7SPRDKBNDJ5RYVSP4).
