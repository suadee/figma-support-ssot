---
기술지원명: Use code snippets in Dev Mode
카테고리: 개발
작성자: Figma
승인자: (승인 대기)
출처: Use code snippets in Dev Mode
출처링크: https://help.figma.com/hc/en-us/articles/15023202277399-Use-code-snippets-in-Dev-Mode
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Once you have an object selected, you can override the default language and
unit.
