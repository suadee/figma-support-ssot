---
기술지원명: Export static designs from Figma
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Export static designs from Figma
출처링크: https://help.figma.com/hc/en-us/articles/360040028114-Export-static-designs-from-Figma
게시일: (승인 대기)
검토일: (승인 대기)
---
...
- Layers, frames, components, groups, or sections. Learn more about [selecting objects in Figma](https://help.figma.com/hc/en-us/articles/360040449873-Select-layers-and-objects).
...
**Note:** You can also export animations from Figma. Learn more about [exporting animated layers](https://help.figma.com/hc/en-us/articles/41307983648407).
...
**Export** section
is located in the right sidebar, but is only visible if you have an object
selected. Learn how to
[export or download assets in Dev Mode](https://help.figma.com/hc/en-us/articles/22012921621015#h_01JWYBRK4VGF5BAPSN9XMQ6GDZ).
...
1. Select the layers you want to export. If you want to export the entire
   canvas of the current page, deselect everything on the canvas.
2. Click the
   plus in the **Export** section to add an export configuration.
   You can add as many export configurations to a selection as needed.
