---
기술지원명: Add descriptions to styles, components, and variables
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Add descriptions to styles, components, and variables
출처링크: https://help.figma.com/hc/en-us/articles/7938814091287-Add-descriptions-to-styles-components-and-variables
게시일: (승인 대기)
검토일: (승인 대기)
---
