---
기술지원명: Apply constraints to define how layers resize
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Apply constraints to define how layers resize
출처링크: https://help.figma.com/hc/en-us/articles/360039957734-Apply-constraints-to-define-how-layers-resize
게시일: (승인 대기)
검토일: (승인 대기)
---
