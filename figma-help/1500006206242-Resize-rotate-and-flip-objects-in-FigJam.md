---
기술지원명: Resize, rotate, and flip objects in FigJam
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Resize, rotate, and flip objects in FigJam
출처링크: https://help.figma.com/hc/en-us/articles/1500006206242-Resize-rotate-and-flip-objects-in-FigJam
게시일: (승인 대기)
검토일: (승인 대기)
---
...
**Tip**: You can also flip shapes on the canvas by dragging any resize handle across the shape to flip it. The shape mirrors along whichever axis you cross. Text on the shape will remain readable if you flip it across an axis.
