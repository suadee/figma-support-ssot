---
기술지원명: Find and replace in Figma
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Find and replace in Figma
출처링크: https://help.figma.com/hc/en-us/articles/9141292269847-Find-and-replace-in-Figma
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Users with can view or can edit access to a file can find text

Users with can edit access to a file can replace text
...
1. Open the  **Files** tab in the navigation bar on the left, then click  **Find** in the left sidebar. Or use the following keyboard shortcut to open the search bar:
   - **Mac:** `Command` + `f`
   - **Windows:** `Ctrl` + `f`
