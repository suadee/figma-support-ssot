---
기술지원명: Migrate to FigJam
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Migrate to FigJam
출처링크: https://help.figma.com/hc/en-us/articles/30458844117271-Migrate-to-FigJam
게시일: (승인 대기)
검토일: (승인 대기)
---
...
>
> *For those that need to be migrated, please export them and send them to [MIGRATION LEAD]. You can also [import them yourself to FigJam](https://help.figma.com/hc/en-us/articles/1500007927941-Import-and-export-with-FigJam). Our team is here to support the migration if needed, but we encourage you to migrate them yourself if you are able to.*
>
...
- [Set up custom colors](https://help.figma.com/hc/en-us/articles/1500004291341-Apply-colors-in-FigJam)
- [Add custom libraries](https://help.figma.com/hc/en-us/articles/1500004290841-Use-stickers-and-libraries-in-FigJam)
