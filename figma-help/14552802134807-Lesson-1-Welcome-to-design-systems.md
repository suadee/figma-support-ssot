...
This is a written version of our [**Introduction to design systems: Lesson 1**](https://www.youtube.com/watch?v=YLo6g58vUm0) video tutorial. Watch the video and follow along with the written course below.
...
Yes, you’ll see aspects of these in a design system, but you’ll also see a focus on the bigger picture: **the entire product ecosystem.![](https://help.figma.com/hc/article_attachments/14675360349719)**
...
It’s important that a design system communicates not just the “what,” but the “how” and the “why.” A design system provides the tools and resources you need to build consistent and cohesive products.![](https://help.figma.com/hc/article_attachments/14675363537047)
...
They also often include on-canvas redlines or annotations, or are embedded alongside code components with detailed documentation.![](https://help.figma.com/hc/article_attachments/14677074590103)
...
In weekly critiques, Kai also noticed components looking different between different designers. They’re beginning to wonder if it’s time to consider a design system.![](https://help.figma.com/hc/article_attachments/14677018586519)
...
These benefits don’t just impact the internal process of building a product. They also contribute to your customer’s experience with the product. Consistency, usability, and accessibility build trust in your product, and lead to a more engaged and loyal customer base in the long run.
...
Take time to observe or reflect on how your product teams work together, the product’s overall experience, and the problem areas we just outlined. If you work in a team, consider discussing as a group.
...
And while they require investment, it might be a while before you ‌see the results of your efforts. This can make it challenging to get buy-in from leadership. Especially if it takes away from day-to-day work, or requires hiring more people.
...
After discovering some design inconsistencies, a need for knowledge sharing with a growing team, and a need for device theming, Kai believes it’s a good time to consider a design system.
...
- 1 
  ...
  Identify user flows and all elements used in product, like colors and text, illustrations and icons, buttons and dropdowns, patterns and interactions, and so on. Collect them all in one place to refer to them later.![](https://help.figma.com/hc/article_attachments/14677112721943)
...
- 2 
  ...
  ![](https://help.figma.com/hc/article_attachments/14677116339735)

  For example: we’ve collected a group of text elements being used in our product. We noticed that we can further categorize these by paragraph, quote, heading 1, and so on. Each of these subcategories have more than one instance per style, which will help us in our evaluation later.![](https://help.figma.com/hc/article_attachments/14677063353879)
- 3 
  ...
  - What inconsistencies are among styles, patterns, and objects?![](https://help.figma.com/hc/article_attachments/14677107805847)
...
Throughout our design systems journey, we’ll likely find ourselves revisiting phases regularly. Some phases may even overlap with one another.
...
If we need something more quick and budget-friendly, we could use or borrow parts of existing design systems as our own.![](https://help.figma.com/hc/article_attachments/14677142957207)

We may base our style guide on an existing one from another company, and only document things we want to do differently. Or, we could build a wireframe library using an existing design kit. We may borrow a token structure from another system, like [Shopify Polaris](https://polaris.shopify.com/), and update it with our own guidelines.
...
[Overview: Introduction to design systems](https://help.figma.com/hc/en-us/articles/14552901442839) [2. Define your system](https://help.figma.com/hc/en-us/articles/14552740206743)
