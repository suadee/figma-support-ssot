---
기술지원명: Create components to reuse in designs
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Create components to reuse in designs
출처링크: https://help.figma.com/hc/en-us/articles/360038663154-Create-components-to-reuse-in-designs
게시일: (승인 대기)
검토일: (승인 대기)
---
...
Figma will nest the layers within a special component frame*.*Identify components in the **Layers** panel using the purple  Component icon. Once created, you can use the [Component configuration settings](https://help.figma.com/hc/en-us/articles/7938814091287-Add-descriptions-to-styles-components-and-variables#components) to add a description and documentation link for collaborators.
...
If you have an existing [instance](https://help.figma.com/hc/en-us/articles/360039150173-Create-and-insert-component-instances) of a deleted component, you can use that instance to restore the component.
