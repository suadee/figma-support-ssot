---
기술지원명: Apply and adjust stroke properties
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Apply and adjust stroke properties
출처링크: https://help.figma.com/hc/en-us/articles/360049283914-Apply-and-adjust-stroke-properties
게시일: (승인 대기)
검토일: (승인 대기)
---
...
**Note:** When you select an object, Figma applies stroke properties to the entire layer. You can use [vector edit mode](https://help.figma.com/hc/en-us/articles/360039957634-Edit-vector-layers) to adjust stroke properties for individual points.
...
**Note:** For advanced stroke customization, the Variable width tool lets you adjust a stroke’s thickness at any point along the path. Learn more about using the [Variable width tool](https://help.figma.com/hc/en-us/articles/360039957634-Edit-vector-layers).
...
1. With the layer selected, press `Enter` to open [vector edit mode](https://help.figma.com/hc/en-us/articles/360039957634-Edit-vector-layers).
