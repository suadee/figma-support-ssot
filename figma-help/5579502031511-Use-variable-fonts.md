---
기술지원명: Use variable fonts
카테고리: 디자인
작성자: Figma
승인자: (승인 대기)
출처: Use variable fonts
출처링크: https://help.figma.com/hc/en-us/articles/5579502031511-Use-variable-fonts
게시일: (승인 대기)
검토일: (승인 대기)
---
...
To replace your static fonts with a variable version, be sure to install the variable version to your device. Learn how to [access installed fonts](https://help.figma.com/hc/en-us/articles/360039956894-Add-a-font-to-Figma-Design).
